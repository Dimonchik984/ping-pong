...
class Button():
    def __init__(
        ...
        self.round_botton = round_botton
    ...
    def draw(self, screen, selected = False):
        ...
        botton_left = border_radius if self.round_botton else 0
        botton_right = border_radius if self.round_botton else 0
